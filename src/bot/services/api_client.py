...
class APIClient:
    ...
    async def send_message(self, telegram_id: int, text: str | None = None, images_bytes: list[tuple[str, bytes]] | None = None, route: str | None = None, roi_preset: str | None = None) -> str:
